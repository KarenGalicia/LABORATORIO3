...
public class PdfReport {
    ...
    private static final com.itextpdf.text.Font TITLE_FONT = new com.itextpdf.text.Font(com.itextpdf.text.Font.FontFamily.TIMES_ROMAN, 14, com.itextpdf.text.Font.BOLD);
    private static final com.itextpdf.text.Font HEADER_FONT = new com.itextpdf.text.Font(com.itextpdf.text.Font.FontFamily.TIMES_ROMAN, 12, com.itextpdf.text.Font.BOLD);
    private static final com.itextpdf.text.Font NORMAL_FONT = new com.itextpdf.text.Font(com.itextpdf.text.Font.FontFamily.TIMES_ROMAN, 12, com.itextpdf.text.Font.NORMAL);
    ...
    private void addTitle(Document document) throws DocumentException {
        Paragraph title = new Paragraph("Karen Yamileth Jiménez Galicia 0905-23-7626", TITLE_FONT); // Actualizado a Productos
    ...
    private void addRowsGroup(PdfPTable table, List<ModelProducto> productos) {
        ...
        com.itextpdf.text.Font boldFont = new com.itextpdf.text.Font(NORMAL_FONT.getFamily(), NORMAL_FONT.getSize(), com.itextpdf.text.Font.BOLD);
